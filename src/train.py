...
Runs 5-fold GroupKFold cross-validation (grouped by question_id) on the dev-set
...
def evaluate_logistic_cv(X, y, groups, n_splits=5, seed=42):
    """
    5-fold GroupKFold cross-validation with a balanced logistic regression classifier.
    Groups by question_id so no question's interactions cross a fold boundary.
